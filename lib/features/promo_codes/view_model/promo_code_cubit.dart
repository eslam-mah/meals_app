...
class PromoCodeState extends Equatable {
  ...
  PromoCodeState copyWith({
    Object? promoCode = _noChange,
    String? errorMessage,
    bool? isLoading,
  }) {
    return PromoCodeState(
      promoCode: promoCode == _noChange ? this.promoCode : promoCode as PromoCodeModel?,
...
// This is a workaround constant to allow "no change" vs "set null" for promoCode.
...
class PromoCodeCubit extends Cubit<PromoCodeState> {
  ...
  Future<void> applyPromoCode(String code) async {
    if (code.isEmpty) {
      emit(state.copyWith(
        promoCode: null, // explicitly set to null
  ...
  void removePromoCode() {
    ...
    emit(state.copyWith(
      promoCode: null, // This will now actually clear it!
      errorMessage: null,
    ));
  }

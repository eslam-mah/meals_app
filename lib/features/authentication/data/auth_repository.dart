...
class AuthRepository {
  ...
  Future<AuthResponse> signInWithPassword(String email, String password) async {
    try {
      ...
      if (errorMsg.contains('user not found') ||
        ...
        throw Exception(
          Intl.defaultLocale == 'ar'
              ? 'كلمة المرور غير صحيحة أو المستخدم غير صالح. يرجى المحاولة مرة أخرى.'
              : 'Incorrect password or Invalid User. Please try again.',
        );
      }
  ...
  Future<AuthResponse> signUpWithEmail(String email, String password) async {
    try {
      ...
      if (response.user != null) {
        try {
          print('Auth repository: Creating user database record');
          ...
          print('Auth repository: User database record created');
        } catch (dbError) {
          print('Auth repository: Failed to create user database record: $dbError');
          // Continue with auth signup regardless of database error
        }
      }
      ...
      if (errorMsg.contains('already registered') ||
        ...
        throw Exception(
          Intl.defaultLocale == 'ar'
              ? 'تنسيق البريد الإلكتروني غير صالح. يرجى التحقق من عنوان البريد الإلكتروني الخاص بك.'
  ...
  Future<void> resetPasswordWithManualToken(
    String email,
    String token,
    String newPassword,
  ) async {
